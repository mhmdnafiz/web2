...
<footer class="bg-danger-subtle py-5" style="display: flex; justify-content: center; align-items: center; text-align: center;">
  <div class="container">
    <span>mhmdnafiz &COPY; 2024. E-Commerce Kelas 3C. ALL rights reserved.</span>
  </div>
</footer>
